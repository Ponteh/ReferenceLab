...
private:
    ...
    std::vector<referencelab::ReferenceMetadata> rows;std::vector<referencelab::ReferencePlaylist> playlistRows;std::vector<referencelab::LibraryDescriptor>libraryRows;juce::ComboBox playlist,librarySelector;juce::Colour appliedMixColour,appliedReferenceColour;
};
