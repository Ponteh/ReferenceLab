...
#include "UI/HeadphoneCorrectionPage.h"
#include <map>
...
private:
    ...
    std::vector<referencelab::ReferenceMetadata> rows;std::vector<referencelab::ReferencePlaylist> playlistRows;std::vector<referencelab::LibraryDescriptor>libraryRows;juce::ComboBox playlist,librarySelector;juce::Colour appliedMixColour,appliedReferenceColour;double libraryWidthRatio=.34,splitterDragStartRatio=.34;bool libraryOpen=true,settingsOpen=false;juce::Component*hoverHelpTarget=nullptr;double hoverHelpStarted=0.0;juce::String activeHelpText;
};
