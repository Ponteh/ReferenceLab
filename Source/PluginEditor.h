...
private:
    ...
    ReferenceLabAudioProcessor&p;referencelab::AnalysisDisplay analysisDisplay;juce::TextButton add{"Aggiungi file"},scan{"Scansiona cartella"},remove{"Rimuovi"},save{"Salva metadati"},savePreset{"Salva preset"},loadPreset{"Carica preset"},resetMeters{"Reset meter"},mix{"MIX"},ref{"REFERENCE"},play{"Play"},pause{"Pause"},stop{"Stop"};
    juce::Label title,mixMeters,referenceMeters,outputMeters,matchedGain,transportStatus;juce::TextEditor search,editTitle,editArtist,editGenre,editBpm,editTags;juce::ToggleButton favouritesOnly{"Solo preferiti"},editFavourite{"Preferita"},autoMatch{"Auto Match"},matchBypass{"Match Bypass"},freezeDisplay{"Freeze"},safeExport{"Safe Export"},loopEnabled{"Loop"},eqBypass{"EQ Bypass"},hpfEnabled{"HPF"},bellEnabled{"Bell"},lpfEnabled{"LPF"},transportSync{"Sync DAW"};juce::ComboBox sort,cacheSize,matchMode,listeningMode,hpfSlope,lpfSlope;juce::Slider manualGain,seek,startOffset,loopStart,loopEnd,fade,hpf,bellFreq,bellGain,bellQ,lpf,syncOffset;juce::ListBox list{"Reference library",this};
