...
{
    auto colour=juce::Colour(0xff9be564);g.setColour(juce::Colour(0xff151d27));g.fillRoundedRectangle(area,5.f);g.setColour(colour);g.drawRoundedRectangle(area,5.f,1.2f);area.reduce(8.f,5.f);
    g.setFont(juce::FontOptions(12.f,juce::Font::bold));g.drawText("OUTPUT",area.removeFromTop(18.f).toNearestInt(),juce::Justification::centredLeft);
    drawLevelBar(g,area.removeFromTop(17.f).reduced(0,2),m.peakDb,colour,"PEAK");drawLevelBar(g,area.removeFromTop(17.f).reduced(0,2),m.rmsDb,colour.withAlpha(.7f),"RMS");
